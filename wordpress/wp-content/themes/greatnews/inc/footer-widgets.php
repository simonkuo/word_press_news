...
class Great_News_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'great_news';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'greatnews' ), $i ),
	...
	function add_footer_widgets() {
		...
		$args = array(
		'container' => 'div',
		'before'    => '<div class="wrapper"><div class="footer-wrapper clear">',
		'after'     => '</div></div>',
		);
...
// Initialize.
$great_news_footer_widgets = new Great_News_Footer_Widgets();
